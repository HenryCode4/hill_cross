...
import { updateSemesterMutation } from "@/lib/api";
import { semesterSchema } from "@/lib/schema";
...
const UpdateSemester = ({
  ...
  const queryClient = useQueryClient();
     const { mutate, isPending } = useMutation({
        mutationFn: (values: z.infer<typeof semesterSchema>) => updateSemesterMutation(event?.id, values),
      });
