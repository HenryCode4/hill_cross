...
const ELearningPage = () => {
      ...
      const [tabState, setTabState] = useState('Examination')
  return (
    <div className="flex h-full w-full flex-col gap-y-[24px] bg-[#F8F8F8] pb-[24px] pt-[90px] lg:gap-y-[43px] lg:px-[52px]">
      <Header title={"E-Learning Uploads"} subTitle={"Examination"} />
      ...
      <Tabs tabState={tabState} setTabState={setTabState} />
        ...
        <div className="flex h-[80px] w-full items-center justify-between px-[32px]">
          <p className="text-[24px] font-[600] leading-[29.05px]">Examination</p>
