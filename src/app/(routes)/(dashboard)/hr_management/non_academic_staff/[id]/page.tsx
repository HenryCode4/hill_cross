  ...
  return (
    <div className="flex h-full w-full flex-col gap-y-[24px] pb-[24px] pt-[90px] lg:gap-y-[43px] lg:px-[52px]">
      <div className="flex flex-col gap-y-[82px]">
        <Header
          title={"Non Academic Staff’s Profile"}
        ...
        <div className="relative flex h-auto w-full flex-col overflow-hidden rounded-[24px] bg-white pb-[24px]">
          <div className="absolute left-[42px] top-[103px]">
            <div className="flex h-[166px] w-[166px] items-center justify-center rounded-full bg-white">
              <div className="flex h-[150px] w-[150px] items-center justify-center rounded-full bg-[#E2E3E5]">
                <Image
                  src={detailsAvatar}
                  alt=""
          ...
          <div className="absolute top-[19px] right-[103px]">
          ...
          <div className="w-full flex gap-y-[34px] flex-col">
            <div className="pl-[222px] pb-[34px] py-[14px] flex flex-col gap-y-[8px]">
                <p className="text-[20px] font-[500]">{"TSHEPISO MODISE"}</p>
                
            </div>
            <div className="grid grid-cols-4 3xl:grid-cols-5 gap-y-[40px] gap-x-[90px] px-[36px]">
        ...
        <div className="flex w-full flex-col gap-y-[24px] rounded-[8px] bg-white p-[24px]">
            ...
            <div className="grid grid-cols-2 gap-x-[20px] gap-y-[24px]">
              ...
              <InputPage title="Gender" required="*" placeholder="Male" />
              <InputPage
                title="Postal Code"
                placeholder="45754"
              />
        ...
        <div className="flex w-full flex-col gap-y-[24px] rounded-[8px] bg-white p-[24px]">
            ...
            <div className="grid grid-cols-2 gap-x-[20px] gap-y-[24px]">
              ...
              <InputPage
                ...
                placeholder=""
              />
              <InputPage title="Account Name" placeholder="" />
              <InputPage  title="Account Type"  placeholder="" />
            </div>
        </div>
