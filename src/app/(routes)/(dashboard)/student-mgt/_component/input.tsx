...
const InputPage = ({placeholder, title, required, className}: InputPageProps) => {
  return (
    <div className={cn("flex flex-col gap-y-[8px]", className) }>
            ...
            <div className="h-[43px] w-full rounded-[8px] border border-[#CEAAAA] bg-[#FCF9F9] overflow-hidden">
                <input placeholder={placeholder} className="w-full h-full bg-[#FCF9F9] px-[16px] outline-none" />
            </div>
