  ...
  return (
        ...
        <div className="w-full flex justify-center  h-full  px-[8px] ">
          ...
          <div className='grid  xl:grid-cols-2 2xl:grid-cols-3 3xl:grid-cols-4 gap-y-[31px] gap-x-[31px]'>
            {
              student.map((item, i) => (
                <div key={i} className='w-full md:w-[350px] h-auto bg-white py-[20px] px-[15px] border border-[#B0B0B0] rounded-[16px] relative'>
              ...
              <p className='text-[20px] font-[500]'>{item.name}</p>
                  ...
                  <div className='w-full pt-[46px] pb-[38px] p-2'>
                    <div className=' flex justify-between w-full border-b '>
                      <p className='py-[14px] font-[400] text-[#5B5B5B]'>Student ID:</p>
                      <p className='py-[14px] font-[500] text-[1rem] text-[#1E1E1E] text-end'>{item.studentId}</p>
                    </div>
                    <div className=' flex justify-between w-full border-b '>
                    ...
                    <div className=' flex justify-between w-full border-b '>
                      <p className='py-[14px] font-[400] text-[#5B5B5B]'>Registration Status:</p>
                      <p className='py-[14px] font-[500] text-[1rem] text-[#1E1E1E] text-end'>{item.registrationStatus}</p>
                    </div>
                    <div className=' flex justify-between w-full border-b '>
                      <p className='py-[14px] font-[400] text-[#5B5B5B]'>Admission Status:</p>
                      <p className='py-[14px] font-[500] text-[1rem] text-[#1E1E1E] text-end'>{item.admissionStatus}</p>
                    </div>
                ...
                {
                  item.registrationStatus === "Completed" && item.admissionStatus === "Registered" && (
                    <div className='w-full flex justify-center items-center gap-x-[16px]'>
                    <div className='w-[44px] h-[44px] cursor-pointer '>
                      <Image  className='w-full h-full object-cover' src={visible} alt='application' />
                    </div>
                    <div className='w-[44px] h-[44px] cursor-pointer'>
                      <Image className='w-full h-full object-cover' src={application} alt='application' />
                    </div>
                    <div className='w-[44px] h-[44px] cursor-pointer'>
                      <Image className='w-full h-full object-cover' src={cancel} alt='application' />
                    </div>
                  </div>
                  )
                }
                ...
                {
                  item.registrationStatus === "Incomplete" && item.admissionStatus === "Admitted" && (
                    <div className='w-full flex justify-center items-center gap-x-[16px]'>
