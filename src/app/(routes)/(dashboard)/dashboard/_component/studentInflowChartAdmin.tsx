...
import useStudentInflowData, { useStudentInflowAdminData } from '@/hooks/useStudentInflowData'

const StudentInflowChartAdmin = () => {
  ...
  return (
    <div className=" flex flex-col gap-[10px] w-full">
              ...
              <RenderBarChart height={319} barSize={20} data={chartData1} fill="#fca7aa" />
              </div>
            </div>
  )
}

export default StudentInflowChartAdmin;